...
# with open("vocabulary-cs.csv", encoding="utf8") as csvfile:
...
print('cs7.5: ' + str(len(json_file_lines)))
print('en7.5: ' + str(len(txt_file_lines)))

for name in txt_file_lines:
    if name not in json_file_lines:
        missing.append(name)
...
# with open('translated_cs_7.2_json.txt', 'w', encoding='utf-8') as f:
#     f.write('\n'.join(txt_file_lines))
#
