...
export const TEST_ENTITY_PUBLICATION = Cypress.env('DSPACE_TEST_ENTITY_PUBLICATION') || '0958c910-2037-42a9-81c7-dca80e3892b4';
...
export const TEST_WITHDRAWN_ITEM_WITH_REASON = Cypress.env('CLARIN_') || 'ce6ceeb4-8f47-4d5a-ad22-e87b3110cc04';
export const TEST_WITHDRAWN_ITEM_WITH_REASON_AND_AUTHORS = Cypress.env('CLARIN_') || 'ad27520a-98c0-40a4-bfc3-2edd857b3418';
export const TEST_WITHDRAWN_REPLACED_ITEM = Cypress.env('CLARIN_') || '94c48fc7-0425-48dc-9be6-7e7087534a3d';
export const TEST_WITHDRAWN_REPLACED_ITEM_WITH_AUTHORS = Cypress.env('CLARIN_') || '0e9ef1cb-5b9f-4acc-a7ca-5a9a66a6ddbd';

export const TEST_WITHDRAWN_REASON = Cypress.env('CLARIN_') || 'reason';
export const TEST_WITHDRAWN_REPLACEMENT = Cypress.env('CLARIN_') || 'new URL';
export const TEST_WITHDRAWN_AUTHORS = Cypress.env('CLARIN_') || 'author1, author2';
