// NOTE (CLARIN/LINDAT): the LINDAT header has no login dropdown menu - authentication goes through the CLARIN top-bar sign-on (DiscoJuice/AAI) and the /login page; the flow is covered by the LINDAT Playwright suite (dspace-ui-tests loginPage).
// The original vanilla spec is kept below for reference.
