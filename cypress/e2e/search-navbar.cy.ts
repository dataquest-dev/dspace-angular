// NOTE (CLARIN/LINDAT): the LINDAT header has no navbar search box - searching goes through the home-page search form and the /search page (covered by homepage.cy.ts and search-page.cy.ts).
