...
describe('Create a new submission', () => {
  ...
  it('Author field should consist of two input fields', {
    ...
    createItemProcess.writeAuthorInputField('Mil');
    createItemProcess.clickOnSuggestionSelection(0);
    cy.wait(500);
    createItemProcess.checkAuthorLastnameFieldValue('Milne');
    createItemProcess.checkAuthorFirstnameFieldValue(' Roger L');
  });
