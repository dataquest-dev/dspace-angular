...
export class FormFieldModel {
  ...
  /**
   * The field controlling the type binding of this field, from `<type-bind field="edm.type">`.
   * Undefined when the attribute is absent: the `submit.type-bind.field` default applies then.
   */
  @autoserialize
