...
import { DsDynamicAutocompleteModel } from '../ds-dynamic-form-ui/models/autocomplete/ds-dynamic-autocomplete.model';
import {
...
export class ComplexFieldParser extends FieldParser {
  ...
  public modelFactory(fieldValue?: FormFieldMetadataValueObject | any, label?: boolean): any {
    ...
    const inputConfigs: DsDynamicInputModelConfig[] = [];
