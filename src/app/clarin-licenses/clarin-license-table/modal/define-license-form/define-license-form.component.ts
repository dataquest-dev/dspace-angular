...
import {
  CLARIN_LICENSE_CONFIRMATION,
  CLARIN_LICENSE_FORM_REQUIRED_OPTIONS,
...
import { ClarinLicenseCheckedPipe } from '../../../../shared/utils/clarin-license-checked.pipe';
import { ClarinLicenseLabelRadioValuePipe } from '../../../../shared/utils/clarin-license-label-radio-value.pipe';
import { ClarinLicenseRequiredInfoCheckedPipe } from '../../../../shared/utils/clarin-license-required-info-checked.pipe';
...
export class DefineLicenseFormComponent implements OnInit, AfterViewInit {
