...
export class SubmissionSectionClarinLicenseComponent extends SectionModelComponent implements OnInit {
  ...
  private getLicenseNameFromRef() {
    ...
    const selectedLicenseId: string = this.licenseSelectionRef.nativeElement.value;
